...
// HangingAttachment describes how a hanging sign is attached to the block that carries it.
...
// WallHangingAttachment returns a HangingAttachment mounted on the side of a block.
func WallHangingAttachment(facing cube.Direction) HangingAttachment {
	return HangingAttachment{facing: facing}
}

// CeilingHangingAttachment returns a HangingAttachment hanging on straight chains below a block.
func CeilingHangingAttachment(facing cube.Direction) HangingAttachment {
	return HangingAttachment{ceiling: true, facing: facing}
}

// AttachedCeilingHangingAttachment returns a HangingAttachment hanging on chains meeting in a point below a block.
