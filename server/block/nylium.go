...
type Nylium struct {
	...
	// Warped is the turquoise variant found in warped forests, as opposed to the crimson variant found in
	// crimson forests.
	Warped bool
}
...
// RandomTick decays the nylium back into netherrack once a block that blocks all light is above it.
